...
{
    /// <summary>
    /// para manipular la data de los empaquetados
    /// </summary>
    ...
    public class EmpaquetadoController : BaseController
    {
        ...
        public EmpaquetadoController(ApplicationDbContext context, IMapper mapper) : base(context, mapper)
        {
        ...
        public async Task<IActionResult> Post(GTipoDTO_in insert)
        {
            ...
            try
            {
                return await Post<GTipoDTO_in, Empaquetado, GTipoDTO_out>(insert);
            }
            catch (Exception ex)
            {
        ...
        public async Task<IActionResult> Get()
        {
            try
            {
                var resp = await Get<Empaquetado, GTipoDTO_out>();
                return Ok(resp);
            }
            catch (Exception ex)
            {
        ...
        public async Task<IActionResult> Get(int id)
        {
            try
            {
                var resp = await Get<Empaquetado, GTipoDTO_out>(id);
                return Ok(resp);
            }
            catch (Exception ex)
            {
        ...
        public async Task<IActionResult> Put(int id, GTipoDTO_in change)
        {
            try
            {
                return await Put<GTipoDTO_in, Empaquetado>(id, change);
            }
            catch (Exception ex)
            {
                Console.WriteLine(ex.Message);
        ...
        public async Task<IActionResult> Delete(int id)
        {
            try
            {
                return await Delete<Empaquetado>(id);
            }
            catch (Exception ex)
            {
                Console.WriteLine(ex.Message);
